...
export const BUTTON_CLASSES =
    "w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer";
...
export const SIDEBAR_CLASSES = {
    ...
    mobileButton:
        "absolute md:hidden top-20 left-5 z-50 mb-10 bg-purple-600 text-white p-2 rounded-full shadow-lg hover:bg-purple-700 transition",
...
export const STATS_GRID =
    "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 md:gap-4 mb-4 md:mb-6";
...
export const CT_CLASSES = {
    ...
    btnGroup:
        "hidden md:flex space-x-1 bg-purple-50 p-1 rounded-lg ml-2 md:ml-3",
    btnBase:
...
export const MENU_OPTIONS = [
    {
        ...
        label: "Edit Task",
        icon: (
            <FilePenLine className="text-purple-600 h-4 w-4 cursor-pointer" />
        ),
    },
    {
        action: "delete",
