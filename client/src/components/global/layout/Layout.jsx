    ...
    if (error) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-50 p-6">
                <div className="text-red-600 p-4 rounded-xl border border-red-100 max-w-md text-lg bg-red-50">
                    <p className=" font-medium mb-2">Error loading task</p>
                    <p className=" text-sm">{error}</p>
                    <button
                        onClick={fetchTasks}
                        className=" mt-4 px-3 py-2 bg-red-100 text-red-700 rounded-lg text-sm font-medium hover:bg-red-200 transition-colors"
                    >
                        Try Again
                    </button>
                </div>
                                ...
                                <div className=" space-y-2 sm:space-y-3">
                                    {tasks.slice(0, 3).map((task) => (
                                        ...
                                        >
                                            ...
                                            ${
                                                task.completed
                                                    ? "bg-green-100 text-gray-700 text-green-700"
                                    ...
                                    {tasks.length === 0 && (
                                        <div className="text-center py-4 sm:py-4 px-2">
                                            <div>
